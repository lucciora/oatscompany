	...
	<nav id="mainNav"
		...
		<div class="container">
			...
			<div class="navbar-header page-scroll">
				<a class="navbar-brand" href="#page-top">Hello! I am Jiin!</a>
			</div>
		...
		<div class="container">
			...
			<br>
				<div class="col-lg-offset-2">
					<p>안녕하세요. 저는 박지인이라고 합니다.
					   저는 데이터 엔지니어로 커리어를 시작하고 싶습니다.
			...
			<div class="col-lg-8 col-lg-offset-2 text-center">
				<a href="https://www.linkedin.com/in/jiin-bak-005107128"
			...
			<div class="row">
				...
				<br>
					<ul>
						...
						<li style="list-type-sytle: none;"><a
							style="list-type-sytle: none;">약빵 - 식품·약품 궁합 분석 플랫폼 </a></li>
						<li style="list-type-sytle: none;"><a
